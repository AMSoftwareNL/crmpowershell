...
online version: https://github.com/AMSoftwareNL/crmpowershell/blob/master/docs/Remove-CrmOptionSet.md
schema: 2.0.0
---
...
```
Remove-CrmOptionSet [-Name] <String> [-Force] [-WhatIf] [-Confirm] [<CommonParameters>]
```
