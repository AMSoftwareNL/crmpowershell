...
online version: http://crmpowershell.amsoftware.nl/Add-CrmBigIntAttribute.html
schema: 2.0.0
---
...
```
Add-CrmBigIntAttribute [-Entity] <String> [-Name] <String> [-DisplayName] <String> [-Description <String>]
...
[http://crmpowershell.amsoftware.nl/Add-CrmBigIntAttribute.html](http://crmpowershell.amsoftware.nl/Add-CrmBigIntAttribute.html)
