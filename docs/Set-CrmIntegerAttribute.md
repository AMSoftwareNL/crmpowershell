...
online version: http://crmpowershell.amsoftware.nl/Set-CrmIntegerAttribute.html
schema: 2.0.0
---
...
```
Set-CrmIntegerAttribute [-Format <CrmIntegerAttributeFormat>] [-MaxValue <Int32>] [-MinValue <Int32>]
...
[http://crmpowershell.amsoftware.nl/Set-CrmIntegerAttribute.html](http://crmpowershell.amsoftware.nl/Set-CrmIntegerAttribute.html)
