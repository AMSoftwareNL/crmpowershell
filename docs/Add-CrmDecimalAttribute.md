...
online version: https://github.com/AMSoftwareNL/crmpowershell/blob/master/docs/Add-CrmDecimalAttribute.md
schema: 2.0.0
---
...
```
Add-CrmDecimalAttribute [-ImeType <CrmImeType>] [-MaxValue <Decimal>] [-MinValue <Decimal>]
 [-Precision <Int32>] [-Entity] <String> [-Name] <String> [-DisplayName] <String> [-Description <String>]
...
### -PassThru
Returns an object that represents the DecimalAttributeMetadata. By default, this cmdlet does not generate any output.
...
[DecimalAttributeMetadata Class](https://docs.microsoft.com/en-us/dotnet/api/microsoft.xrm.sdk.metadata.decimalattributemetadata.aspx)
