...
online version: https://github.com/AMSoftwareNL/crmpowershell/blob/master/docs/Add-CrmLanguage.md
schema: 2.0.0
---
...
```
Add-CrmLanguage [-LocaleId] <Int32> [-Force] [-WhatIf] [-Confirm] [<CommonParameters>]
```
