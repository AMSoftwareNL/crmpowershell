...
online version: https://github.com/AMSoftwareNL/crmpowershell/blob/master/docs/Set-CrmDecimalAttribute.md
schema: 2.0.0
---
...
```
Set-CrmDecimalAttribute [-ImeType <CrmImeType>] [-MaxValue <Decimal>] [-MinValue <Decimal>]
...
[DecimalAttributeMetadata Class](https://docs.microsoft.com/en-us/dotnet/api/microsoft.xrm.sdk.metadata.decimalattributemetadata)
